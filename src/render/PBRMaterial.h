   ...
   public:
    ...
    PBRMaterial() {
        ...
        sc->registerConstantDataDef(ConstantDataDef(
            "attr", CDT_ConstantBuffer, sizeof(PBRMaterialAttr), 0));
        sc->registerConstantDataDef(ConstantDataDef(
            "light", CDT_ConstantBuffer, sizeof(PBRMaterialLight), 1));
        sc->registerConstantDataDef(ConstantDataDef(
            "camera", CDT_ConstantBuffer, sizeof(PBRMaterialCamera), 2));
        sc->registerConstantDataDef(
            ConstantDataDef("albedo_texture", CDT_Texture2D, 0, 0));
        sc->registerConstantDataDef(
            ConstantDataDef("metallic_texture", CDT_Texture2D, 0, 1));
        sc->registerConstantDataDef(
            ConstantDataDef("roughness_texture", CDT_Texture2D, 0, 2));
    }
