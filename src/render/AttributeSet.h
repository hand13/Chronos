...
namespace Geometry {
    ...
    class Attribute {
        ...
        Type dataType;
        Attribute(){}
        Attribute(const std::string & name,Type dataType):name(name),dataType(dataType){}
    };
    ...
    class AttributeSet {
        ...
        inline const Attribute& getAttribute(const std::string & attributeName)const{
            return attributeSet.at(attributeName);
        }
        inline size_t getAttributesLength()const{
