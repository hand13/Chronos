...
void ControlUI::init(Renderer* renderer) {
    ...
    wc = {sizeof(WNDCLASSEX),    CS_CLASSDC, WndProc, 0L,   0L,
          ...
          _T("Chronos Editor"),  NULL};
    ::RegisterClassEx(&wc);
    hWnd = ::CreateWindow(wc.lpszClassName, _T("Chronos Editor"),
...
void ControlUI::runInLoop() {
    ...
    if (resizeHeight != 0 && resizeWidth != 0) {
        rtv->Release();
        swapChain->ResizeBuffers(0, resizeWidth, resizeHeight,
    ...
    // to created a named window.
    {
        ...
        // window called "Hello, world!" and append into it. ImGui::End();
    }
...
void ControlUI::quit() { finished = true; }
bool ControlUI::createSwapChain() {
    ...
    if (FAILED(factory->CreateSwapChain(device.Get(), &sd,
...
bool ControlUI::isStop() { return finished; }
}  // namespace Chronos
