...
void ControlUI::init(){
    ...
    wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T("ImGui Control"),NULL};
    ::RegisterClassEx(&wc);
    hWnd = ::CreateWindow(wc.lpszClassName, _T("Chronos Imgui"), WS_OVERLAPPEDWINDOW, 100, 100, 600, 600, NULL, NULL, wc.hInstance,this);
    ...
    if (!CreateDeviceD3D(hWnd))
    {
        ...
        throw std::exception("create imgui window failled");
    }
